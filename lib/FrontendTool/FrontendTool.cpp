...
generateSILModules(CompilerInvocation &Invocation, CompilerInstance &Instance, FrontendObserver *observer) {
...
static bool performCompile(CompilerInstance &Instance,
  ...
  std::deque<PostSILGenInputs> PSGIs = generateSILModules(Invocation, Instance, observer);
